      ...
      <div className="glass-card rounded-2xl p-8 md:p-12 max-w-lg w-full mx-4">
        <div className="flex flex-col items-center text-center">
          ...
          <button 
            ...
            disabled={isLoading}
            className="glow-button flex items-center gap-3 px-10 py-4 rounded-lg text-primary-foreground font-display font-bold text-lg uppercase tracking-wider disabled:opacity-50"
          >
